 ...
 * Brief   : 蓝鞋，主角使用后，可以跳跃两次
 * Version :
 */

var BlueShoes = cc.Class.extend({
	...
	_unavailable	:	false,
	_continuedTime	:	5000,	//可持续时间

	//动作
	_rotatingAction	:	null,

	ctor : function (x, y, continuedTime) {
		...
		this._batchnode = new cc.SpriteBatchNode(res.shoes.png);
		...
		//对象
		this._sprite = new cc.PhysicsSprite("#shoes_00.png");
